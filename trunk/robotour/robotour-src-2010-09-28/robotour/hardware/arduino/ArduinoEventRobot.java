...
import robotour.navi.local.birdseye.PosePredictor;
...
//        iframe.setImage(birdsEye.getFloorImage());
    ...
    void startVideoSamplingThread() {
        final VideoEventRecorder videoRecorder = new VideoEventRecorder(VideoInputs.getVideo(), eventLog);
...
//                        Logger.getLogger(ArduinoEventRobot.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String[] args) throws Exception {
        ...
        final ArduinoSerial arduino = ArduinoSerial.getArduino("COM11");
