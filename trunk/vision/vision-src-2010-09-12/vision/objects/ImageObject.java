...
//        x2.scaleAdd(tX, atob, a);
        ...
        if (Double.isInfinite(tX)) {
            ...
            x3 = camProp.getProjectionVectorPixels(x2.x, x2.y);
            if (tX < 0) {
                x3.scale(-1);
            }
        }
...
//        y2.scaleAdd(tY, btoc, b);
        ...
        if (Double.isInfinite(tY)) {
            ...
            y3 = camProp.getProjectionVectorPixels(y2.x, y2.y);
            if (tY > 0) {
                y3.scale(-1);
            }
        }
    ...
    public Transform3D getTransform(CameraProportions camProp) {
        ...
        Vector3d centerDir = camProp.getProjectionVectorPixels(centerP.x, centerP.y);
...
//        centerDir.normalize();
        ...
        Vector3d bVect = camProp.getProjectionVectorPixels(b.x, b.y);
