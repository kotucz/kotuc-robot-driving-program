...
/**
 *
 * This can draw images of 3D object with image background.
 *
 * @author Kotuc
 */
...
//            canvas3D.setSize(320, 240);
        Screen3D screen = canvas3D.getScreen3D();
        screen.setSize(bg.getWidth(), bg.getHeight());
        screen.setPhysicalScreenWidth(0.4);
        screen.setPhysicalScreenHeight(0.3);

//        Point3d eye = new Point3d(0.5, 0, 2);
//        canvas3D.setLeftManualEyeInImagePlate(eye);
//        canvas3D.setRightManualEyeInImagePlate(eye);
