...
public class PilotTest {
    ...
    public static void main(String[] args) throws InterruptedException, MeasureException {
        ...
        Pilot pilot = new Pilot(system.getWheels(), system.getCompass());
    ...
    static void metreNback(Pilot pilot) {
        // forward
        pilot.travel(1.0, false);
        // right
     ...
     *  S^
     */
    static void fwRtNback(Pilot pilot) {
        // forward
        pilot.travel(1.0, false);
        // right
    ...
    static void rightSquare(Pilot pilot) {
        double side = 1.0;
    ...
    private static void compassSquare(Pilot pilot, Compass compass) {
        try {
