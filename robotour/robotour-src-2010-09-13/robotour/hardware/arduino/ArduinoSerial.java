 ...
 * @author Kotuc
 */
public class ArduinoSerial implements SerialPortEventListener, Shutdownable {
...
//    public SharpScanReader sharpReader;
    ...
    public ArduinoSerial(InputStream inputStream, OutputStream outputStream) {
        this.is = inputStream;
    ...
    public ArduinoSerial(CommPortIdentifier portId) throws IOException {
        try {

// listening
            this.serialPort = (SerialPort) portId.open("ArduinoSerial", 2000);
...
//
//    }
    public static ArduinoSerial getArduino(String portName) throws PortInUseException, UnsupportedCommOperationException, IOException {
...
//                SerialPort.PARITY_NONE);
        ...
        return new ArduinoSerial(portId);
