...
import vision.colors.HSHistogram;
import vision.imagej.HSB;
import vision.objects.MegaSuperObjectAnalysis;
import vision.pathfinding.CharacteristicsRecog;
import vision.pathfinding.FloorProjection;
import vision.pathfinding.KnownRecog;
...
//    }
    ...
    static BufferedImage hsTable(BufferedImage input) {
        return new HSHistogram().parse(input);
    }

    static BufferedImage hsRoad(BufferedImage input) {
        return HSHistogram.roadTable();
    }
